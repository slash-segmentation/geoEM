...
class MeshExtractor : public CGAL::Modifier_base<typename Polyhedron3::HalfedgeDS>
{
...
public:
    MeshExtractor(const VertexCollection verts, bool only_enclosed=true) :
...
Polyhedron3* extract_mesh(VertexCollection verts, bool only_enclosed=true)
{
    MeshExtractor<Polyhedron3, VertexCollection> extractor(verts, only_enclosed);
